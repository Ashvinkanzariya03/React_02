  ...
  return (
    <>
        <div className="container">
            ...
            <button className="btn btn-primary me-3" onClick={handelClickLw}>Convert to Lowercase</button>
            <button className="btn btn-primary me-3" onClick={handelClickClear}>Clear</button>
            <button className="btn btn-primary me-3" onClick={handelClickcapital}>Capitalized</button>
        </div>
        <div className="container my-5">
            <h1>Your summary</h1>
            <h4>Words:- {text.trim() === "" ? 0 : text.trim().split(/\s+/).length }</h4>
